...
2. If using XAMPP open it and start 'Apache'.
    ...
    Pay attention: Skype may prevent the connection to the local web server. So, make sure Skype turns off while trying to connect (after the web server execute you can use Skype again).
